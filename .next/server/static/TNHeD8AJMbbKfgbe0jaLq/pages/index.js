...
function (_React$Component) {
  ...
  function Rooms() {
    ...
    Rooms_defineProperty(Rooms_assertThisInitialized(_this), "state", {
      rooms: [{
        id: "room1",
        name: "Room 1",
        checkbox: false,
    ...
    Rooms_defineProperty(Rooms_assertThisInitialized(_this), "onSubmitClick", function () {
    ...
    Rooms_defineProperty(Rooms_assertThisInitialized(_this), "onRoomsSelectionChange", function (room) {
      var rooms = Object.assign([], _this.state.rooms);

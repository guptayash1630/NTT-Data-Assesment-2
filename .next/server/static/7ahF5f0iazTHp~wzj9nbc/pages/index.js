...
function (_React$Component) {
  ...
  function BookRoomComponent() {
    ...
    _defineProperty(BookRoomComponent_assertThisInitialized(_this), "state", {
      id: _this.props.id,
    ...
    _defineProperty(BookRoomComponent_assertThisInitialized(_this), "handleAdultDropDownChange", function (event) {
      _this.setState({
    ...
    _defineProperty(BookRoomComponent_assertThisInitialized(_this), "handleChildrenDropDownChange", function (event) {
      _this.setState({
    ...
    _defineProperty(BookRoomComponent_assertThisInitialized(_this), "handleCheckboxChange", function (event) {
